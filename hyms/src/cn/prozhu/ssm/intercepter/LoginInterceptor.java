package cn.prozhu.ssm.intercepter;
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (url.indexOf("login.action") >= 0 || url.indexOf("logout.action") > 0 || url.indexOf("checkLoginName.action") > 0 || url.indexOf("register.action") > 0 || url.indexOf("success.action") > 0) {
            return true;
        }
