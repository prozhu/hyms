...
<body class="easyui-layout">
    ...
    <div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <div class="wu-header-right">
            <p><span>在线人数: ${count} &nbsp &nbsp &nbsp&nbsp&nbsp</span><strong class="easyui-tooltip" title="">${member.loginname}</strong>，欢迎您！</p>
            <p><a href="${baseurl}logout.action">网站首页</a>|<a href=javascript:help()>帮助中心</a>|<a id="loginOut" href=javascript:logout()>退出系统</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
                ...
                if(iframe){
                    ...
                    tabPanel.tabs('add',{
                        ...
                        extractor: function(data){  
                             ...
                             //记录本tab中的所有带ID的DIV  
                                 tabPanel.tabs('getTab',title).divs = ids;  
                                 return data;  
                             }  
                    });
                }
		...
		function help() {
			/* _confirm("帮助中心正在建设中。。。", null, function() {
	          ...
	          $.messager.show({
	                title:'使用说明',
	                msg:
	                	'一、会员卡的激活、挂失、挂失解除说明：<br>    1. 会员卡只有在禁用的状态下允许激活  <br>2.会员卡挂失只有在正常的状态允许挂失<br>3.会员卡只有在挂失的状态下允许挂失解除<br><br>'
